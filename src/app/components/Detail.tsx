    ...
    <div className="pt-[50px]">
      ...
      <div className="bg-white flex flex-col justify-center text-center px-auto">
        ...
        <p className="text-[12px] pt-5 justify-center items-center px-[5%] sm:px-[10%] md:px-[28%] text-justify font-bold">
          ...
          understanding of scientific concepts and a keen analytical approach.
        </p>
        <p className="text-[12px] pt-5 justify-center items-center px-[5%] sm:px-[10%] md:px-[28%] text-justify font-bold">
          In addition to my scientific expertise, I am well-versed in computer
        ...
        <p className="text-[12px] pt-5 justify-center items-center px-[5%] sm:px-[10%] md:px-[28%] text-justify font-bold">
          ...
          further enhancing my communication skills. This has provided me with a
          strong command of both written and verbal English, enabling effective
          communication in professional settings.
        </p>
        <p className="text-[12px] pt-5 justify-center items-center px-[5%] sm:px-[10%] md:px-[28%] text-justify font-bold">
          With a diverse educational background and a passion for continuous
          growth, I am eager to apply my skills in roles that demand adaptability,
          attention to detail, and effective communication. My interdisciplinary
          knowledge, coupled with practical skills, makes me a versatile professional
          ready to contribute to various fields.
        </p>
      </div>
      ...
      <div className="bg-white flex flex-col justify-center text-center px-8 pb-[50px]">
        ...
        <p className="text-[12px] pt-5 justify-center items-center px-[5%] sm:px-[10%] md:px-[28%] text-justify font-bold">
          <span className="text-yellow-500 font-semibold text-lg">Web & Mobile App Development</span><br />
          Currently enrolled in a comprehensive Web and Mobile App Development course at 
          <span className="text-[#AF3CFF] font-semibold"> Syalni Mass IT Training Center</span>
          to deepen my expertise in front-end and back-end technologies.
        </p>
        <p className="text-[12px] pt-5 justify-center items-center px-[5%] sm:px-[10%] md:px-[28%] text-justify font-bold">
          <span className="text-yellow-500 font-semibold text-lg">Web 3.0, Artificial Intelligence (AI), and Metaverse</span><br />
          Pursuing an advanced course on Web 3.0, Artificial Intelligence, and the Metaverse at
          <span className="text-[#AF3CFF] font-semibold"> Grosvenor House</span> to explore and understand cutting-edge technologies shaping
