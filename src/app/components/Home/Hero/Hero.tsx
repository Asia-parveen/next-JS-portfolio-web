      ...
      <div className="w-[80%] mx-auto  grid grid-cols-2 lg:grid-cols-5 items-center gap-[5rem]">
        ...
        <div className="col-span-3">
          <h1
            data-aos="fade-right"
            data-aos-delay="400"
            className="text-[20px] uppercase xl:text-[26px] text-yellow-500 font-semibold"
          >
            Hello I&apos;m
          </h1>
          ...
          <h1
            data-aos="fade-right"
            data-aos-delay="800"
            className="text-[25px] lg:text-[28px] xl:text-[35px] text-white text-opacity-80"
          >
            Software Developer
          </h1>
          <p
          ...
          <button
            data-aos="zoom-in"
            data-aos-delay="1200"
            className=" group  mt-[2rem] relative h-12 w-48 overflow-hidden rounded-full bg-[#E487FF] text-lg shadow group"
          >
